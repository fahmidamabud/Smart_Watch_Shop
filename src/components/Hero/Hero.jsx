...
import watch1 from "../../assets/watch/watch_3.png";
import watch2 from "../../assets/watch/watch_2.png";
import watch3 from "../../assets/watch/watch_1.png";
...
const Hero = ({ handleOrderPopup }) => {
  ...
  const [description, setDescription] = React.useState(
    "Fast Watch is an innovative company for your next pick for smart watch. Our collection of watches are designed to make your life easier and more convenient. Choose from our wide range of watches and find the perfect one for you. Shop now and experience the difference.We offer a wide range of watches for men, women, and kids. From classic watches to modern ones, we have something for everyone. Shop now and find the perfect watch for you."
  );
  ...
  return (
    <>
      <div className="min-h-[550px] sm:min-h-[700px] bg-gray-100 flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200 relative">
        <div className="h-[700px] w-[700px] bg-primary_dark/40 absolute -top-1/2 right-0 rounded-3xl rotate-45 -z-9"></div>
            ...
            >
              ...
              >
                <button
                  ...
                  className="bg-gradient-to-r from-primary_dark to-primary hover:scale-105 duration-200 text-white py-2 px-4 rounded"
                >
                  Order Now
                </button>
              </div>
